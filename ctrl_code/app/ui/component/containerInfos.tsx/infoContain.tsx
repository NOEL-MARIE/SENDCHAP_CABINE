...
export const InfoContainer = ({
 ...
 // Titre par défaut
  ...
  return (
    <div
      className={clsx(
        "border border-gray_folio font-FiraCode mt-4 w-[300px] h-[250px] flex flex-col"
      )}
    >
      {/* Titre */}
      <div
        className={clsx(
          "flex items-center justify-center h-[50px] text-gray-800"
        )}
      >
        {title}
      </div>
      ...
      <div className={clsx("flex-1 p-4  text-gray-700 overflow-y-auto break-words")}>
        {content}
      </div>
    </div>
  );
